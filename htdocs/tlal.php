...
<div class="grid">
  ...
  <a href="?page=videostlal" class="button-tile">
    <img loading="lazy" src="proxyic.php?id=1RVLAWz-jjde0xD6sSw4mmfVRoGlhWjGg" alt="شعار 1">
    <p>❤️فيديوهات طلال❤️</p>
  </a>

  <a href="?page=imgtlal" class="button-tile">
...
$folderId = "1Js13d2OhphAcB64pZKwJ7_Nd8NVhn64L";
$optParams = [
...
<body>
  ...
  <h2>❤️فيديوهات طلال❤️</h2>

  <a href="?page=tlal" class="back-btn">←العودة</a>
...
$folderId = "1Jx_Nz_ykuy5bM2xTBIwwNTHG8tRDP1Sn";
$optParams = [
