...
$folderId = "1adVgZfFiaNx0gtlWnrEIDh8r8OZYEp2F";
...
<head>
  <meta charset="UTF-8" />
  <title>فيديوهات إيما ستون</title>
  <style>
    body {
      background: black;
      font-family: 'Segoe UI', sans-serif;
...
$folderId = "1amWA1rMc3UN-vyEJgg6yk4eadl91vd7t";
$results = $service->files->listFiles([
    'q' => "'$folderId' in parents and trashed = false",
    'fields' => 'files(id,name,mimeType,thumbnailLink)'
]);
