...
<head>
  <meta charset="UTF-8">
  <title>معارض إميليا كلارك</title>
  <style>
    body {
      background: black;
...
$folderId = "1Ugul64FKmUcTB1J2myErMMK8f2qGI4Kr";
...
<head>
  <meta charset="UTF-8" />
  <title>فيديوهات إميليا كلارك</title>
  <style>
    body {
      background: black;
      font-family: 'Segoe UI', sans-serif;
...
<body>
  ...
  <h2>فيديوهات إميليا كلارك</h2>

  <a href="?page=em" class="back-btn">←العودة</a>
