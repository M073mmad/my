...
$folderId = "1e6c9MnnHzPwepG8Hzc25KefBs7e4jE7b";
...
<head>
  <meta charset="UTF-8" />
  <title>فيديوهات اردا قولير</title>
  <style>
    body {
      background: black;
      font-family: 'Segoe UI', sans-serif;
...
$folderId = "1e5wDO7VHtPRxjaH2UcAUprAV3VaFGoHA";
$results = $service->files->listFiles([
    'q' => "'$folderId' in parents and trashed = false",
    'fields' => 'files(id,name,mimeType,thumbnailLink)'
]);
