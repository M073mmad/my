...
$folderId = "1Wy5id4EXJHXN8HrCGzLy15-4FDo8DiBw";
...
<head>
  <meta charset="UTF-8" />
  <title>❤️فيديوهات ابودقمة❤️</title>
  <style>
    body {
      background: black;
      font-family: 'Segoe UI', sans-serif;
...
<body>
  ...
  <h2>❤️فيديوهات ابودقمة❤️</h2>

  <a href="?page=dgmh" class="back-btn">←العودة</a>
...
$folderId = "168P1zwCUw6HpuzfZpKTKpYScom7BqMqn";
$results = $service->files->listFiles([
    'q' => "'$folderId' in parents and trashed = false",
    'fields' => 'files(id,name,mimeType,thumbnailLink)'
]);
