...
$folderId = "13zRHfz4F14dVrin2zHvMNm-hPG4x40Co";
...
<body>
  ...
  <a href="?page=eesa" class="back-btn">←العودة</a>
...
$folderId = "15NBC9tV8L9NynFzSIRWi1MTx2fXznwwK";
$results = $service->files->listFiles([
    'q' => "'$folderId' in parents and trashed = false",
    'fields' => 'files(id,name,mimeType,thumbnailLink)'
]);
