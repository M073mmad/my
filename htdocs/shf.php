...
<div class="dashboard">
  <h1>شفايف و فخوذ</h1>
  <a href="?page=imgshf" class="btn">الصور</a>
  <a href="?page=videosshf" class="btn">الفيديوهات</a>
  <a href="?page=pagesshf" class="btn">الصفحات</a>
...
<h1>الصفحات</h1>
  ...
  <a href="?page=shf" class="back-btn">←العودة</a>

<div class="grid">
  
  <a href="tlal.php" class="button-tile">
...
$folderId = "1O-cayl_xFaZMHdA8zAZ17i9DuFr3UCbZ";
$optParams = [
...
$service = new Google_Service_Drive($client);
$folderId = "1O00OhM5pwqN_998EUYqClyodXrbK3slp";
$optParams = [
...
<head>
  <meta charset="UTF-8" />
  <title>فيديوهات شفايف و فخوذ</title>
  <style>
    body {
      background: black;
      font-family: 'Segoe UI', sans-serif;
